...
for epoch in range(max_epochs):
    ...
    for batch_data in train_loader:
        ...
        optimizer.zero_grad()
        with torch.cuda.amp.autocast():
            outputs,outputs1,outputs2,outputs3 = model(inputs)
            loss = loss_function(outputs, labels)+loss_function(outputs1, labels)+loss_function(outputs2, labels)+loss_function(outputs3, labels)
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            for val_data in val_loader:
                ...
                val_outputs,_,_,_ = inference(val_inputs)
            ...
            for val_data in val_loader2:
                ...
                val_outputs2,_,_,_ = model(val_inputs2)
